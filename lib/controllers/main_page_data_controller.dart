...
import 'package:movie_app_project/models/movie.dart';
import 'package:movie_app_project/services/movie_service.dart';
import 'package:movie_app_project/models/search_categorie.dart';
...
class MainPageDataController extends StateNotifier<MainPageData> {
  ...
  void updateSearchCategoreie(String? _category) {
    try {
      state = state.copyWith(
